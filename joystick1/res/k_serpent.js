...
window.setInterval(serpent_touch, 5);
...
function serpent_touch(joystick){ // gestion du sens de deplacement en fonction du joystick
  $.ajax({
  url: "joystick",
  type: "GET",
  dataType: "html",
  success: function(deplacement){
  	if(!deplacement){
  		return;
  	}
	...
	var touche=deplacement;//evt.keyCode;
